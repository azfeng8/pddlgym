(define (domain bakingrealistic)
    ...
    ; (:actions pour-powdery-ingredient-from-measuring-cup pour-mixture-only pour-powdery-ingredient-from-container transfer-butter-from-pan-or-bowl transfer-egg-from-pan-or-bowl move-baked-good-in-container-to-different-container crack-egg-and-put-in-container put-butter-in-container-from-measuring-cup put-pan-in-oven preheat-oven-with-cake-settings preheat-oven-with-souffle-settings use-stand-mixer remove-pan-from-oven set-oven-with-cake-bake-time-and-press-start set-oven-with-souffle-bake-time-and-press-start separate-raw-yolk-from-egg-whites beat-egg-whites fold-stiff-egg-whites-into-mixture)
...
:precondition (and
    (separate-raw-yolk-from-egg-whites ?x ?y ?eggyolkcontainer ?eggwhitescontainer)
    (is-egg ?x)
    (is-whole-raw-egg ?x)
    (not (is-in-shell ?x))
    (not (is-egg ?y))
...
:precondition (and 
    (put-butter-in-container-from-measuring-cup ?b ?p)
    (is-butter ?b)
    (is-pan ?p)
...
:precondition (and
    (put-butter-in-container-from-measuring-cup ?butter ?bowl)
    (is-butter ?butter)
...
:precondition (and
    (put-butter-in-container-from-measuring-cup ?butter ?pan)
...
:precondition (and
    (transfer-egg-from-pan-or-bowl ?from ?to ?egg)
...
:precondition (and
    (transfer-butter-from-pan-or-bowl ?from ?to ?butter)
...
:precondition (and
    (set-oven-with-cake-bake-time-and-press-start ?oven)
...
:precondition (and
    (set-oven-with-souffle-bake-time-and-press-start ?oven)
...
:precondition (and
    (fold-stiff-egg-whites-into-mixture ?s ?from ?to ?e)
...
:parameters (?mixer - electric_stand_mixer ?bowl - container ?mixture - mixture_hypothetical ?egg1 - egg_hypothetical ?egg2 - egg_hypothetical ?cupsofflour - powder_ingredient_hypothetical ?tablespoonsofflour - powder_ingredient_hypothetical ?sugar - powder_ingredient_hypothetical ?bakingpowder - powder_ingredient_hypothetical ?butter - butter_hypothetical)
:precondition (and
...
;:parameters (?mixer - electric_stand_mixer ?bowl - container ?mixture - mixture_hypothetical ?butter - butter_hypothetical ?sugar - powder_ingredient_hypothetical ?tablespoonsofflour - powder_ingredient_hypothetical ?bakingpowder - powder_ingredient_hypothetical ?egg - egg_hypothetical)
;:precondition (and
;    (use-stand-mixer ?mixer ?bowl ?mixture)
;    (is-bowl ?bowl)
;    (mixture-is-hypothetical ?mixture)
...
;    (is-baking-powder ?bakingpowder)
;    (not (powder-ingredient-in-container ?bakingpowder ?bowl))
;)
;:effect (and
;    (is-mixture ?mixture)
;    (not (mixture-is-hypothetical ?mixture))
...
;:precondition (and
;   (use-stand-mixer ?mixer ?pan ?mixture)
;   (is-pan ?pan)
;   (mixture-is-hypothetical ?mixture)
;   (is-butter ?butter)
;   (is-sugar ?sugar)
