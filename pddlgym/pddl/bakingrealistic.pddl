(define (domain bakingrealistic)
	...
	(:types container butter_hypothetical measuring_cup oven dessert_hypothetical electric_stand_mixer egg_hypothetical powder_ingredient_hypothetical mixture_hypothetical spatula)
	(:predicates
...
; (:actions pour-powdery-ingredient-from-measuring-cup pour-mixture-only pour-powdery-ingredient-from-container transfer-butter-from-pan-or-bowl transfer-egg-from-pan-or-bowl move-baked-good-in-container-to-different-container crack-egg-and-put-in-container put-butter-in-container-from-measuring-cup put-pan-in-oven preheat-oven-with-cake-settings preheat-oven-with-souffle-settings use-stand-mixer remove-pan-from-oven set-oven-with-cake-bake-time-and-press-start set-oven-with-souffle-bake-time-and-press-start separate-raw-yolk-from-egg-whites beat-egg-whites fold-stiff-egg-whites-into-mixture)
	...
	(:action place-souffle-on-plate
		...
		:precondition (and (move-baked-good-in-container-to-different-container ?from ?to ?souffle)
	...
	(:action use-stand-mixer-in-bowl-with-mixture-set1-baking-powder-butter-cups-of-flour-sugar-whole-raw-egg
		:parameters (?mixer - electric_stand_mixer ?bowl - container ?mixture - mixture_hypothetical ?egg0 - egg_hypothetical ?egg1 - egg_hypothetical ?egg2 - egg_hypothetical ?egg3 - egg_hypothetical ?egg4 - egg_hypothetical ?egg5 - egg_hypothetical ?egg6 - egg_hypothetical ?egg7 - egg_hypothetical ?cupsofflour - powder_ingredient_hypothetical ?tablespoonsofflour - powder_ingredient_hypothetical ?sugar - powder_ingredient_hypothetical ?bakingpowder - powder_ingredient_hypothetical ?butter - butter_hypothetical)
		:precondition (and (use-stand-mixer ?mixer ?bowl ?mixture)
			...
			(not (egg-in-container ?bowl ?egg4))
			(not (egg-in-container ?bowl ?egg5))
			(not (egg-in-container ?bowl ?egg6))
			(not (egg-in-container ?bowl ?egg7))
			...
			(name-less-than ?egg0 ?egg4)
			(name-less-than ?egg0 ?egg5)
			(name-less-than ?egg0 ?egg6)
			(name-less-than ?egg0 ?egg7)
			(name-less-than ?egg2 ?egg3)
			(name-less-than ?egg2 ?egg4)
			(name-less-than ?egg2 ?egg5)
			(name-less-than ?egg2 ?egg6)
			(name-less-than ?egg2 ?egg7)
			(name-less-than ?egg3 ?egg4)
			(name-less-than ?egg3 ?egg5)
			(name-less-than ?egg3 ?egg6)
			(name-less-than ?egg3 ?egg7)
			(name-less-than ?egg4 ?egg5)
			(name-less-than ?egg4 ?egg6)
			(name-less-than ?egg4 ?egg7)
			(name-less-than ?egg5 ?egg6)
			(name-less-than ?egg5 ?egg7)
			(name-less-than ?egg6 ?egg7)
			(different ?egg0 ?egg1)
			(different ?egg1 ?egg2)
			(different ?egg1 ?egg3)
			(different ?egg1 ?egg4)
